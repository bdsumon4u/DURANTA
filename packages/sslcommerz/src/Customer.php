...
class Customer
{
    ...
    private $_email;
    private $_phone;
    private $_address_1 = 'cus_add1';
    private $_address_2 = 'cus_add2';
    private $_city = 'cus_city';
    private $_state = 'cus_state';
    private $_post_code = 'cus_post_code';
    private $_country = 'cus_country';
    private $_fax = 'cus_fax';
