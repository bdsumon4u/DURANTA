        ...
        <div class="container">
            <div class="flex flex-col justify-between flex-1 p-4 my-8 bg-white rounded-lg shadow-md md:flex-row">
                <div class="flex items-center justify-center mb-4 md:mb-0">
                    <img class="w-20 h-20 mr-2 border border-solid" :src="seller.data.store_logo" />
                    <div class="ml-4">
                        <h1 class="text-xl md:text-3xl font-semibold">{{ seller.data.store_name }}</h1>
                        <span class="text-gray-600">products found in {{ seller.data.store_name }}</span>
                    </div>
                </div>
