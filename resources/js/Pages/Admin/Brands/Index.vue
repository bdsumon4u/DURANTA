                ...
                <div class="w-96">
                    <div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-gray-900">{{ brand ? 'Edit Brand' : 'Add New Brand' }}</h2>
                            <p v-if="brand" class="mt-2 text-sm text-gray-400">You're editing "{{ brand.name }}"</p>
                        </div>
                                    ...
                                    <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                        <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                            <div v-if="src" class="flex flex-auto mx-auto">
                                                <img class="has-mask h-28 w-28 object-center" :src="src" alt="Brand Image">
                                            </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            if (this.brand) {
                this.$inertia.post(route('admin.brands.update', this.brand), {
                    _method: 'PATCH',
                    ...this.form,
                }, {
