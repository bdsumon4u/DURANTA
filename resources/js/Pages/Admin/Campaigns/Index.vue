                ...
                <div class="w-96">
                    <div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-gray-900">{{ campaign ? 'Edit Campaign' : 'Add New Campaign' }}</h2>
                            <p v-if="campaign" class="mt-2 text-sm text-gray-400">You're editing "{{ campaign.data.name }}"</p>
                        </div>
