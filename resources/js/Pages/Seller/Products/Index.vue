                                ...
                                <tr class="hover:bg-gray-200" v-for="product in products.data" :key="product.id">
                                    ...
                                    <td class="px-3 py-3 whitespace-nowrap text-sm text-center font-medium w-28">
                                        <div class="flex flex-col space-y-2">
                                            <inertia-link class="px-4 py-2 border rounded-md bg-blue-600 text-gray-100 hover:bg-blue-700 hover:text-white" :href="route('seller.products.edit', product.id)">Edit</inertia-link>
