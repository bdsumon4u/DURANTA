                    ...
                    <div v-if="admin" class="sm:max-w-lg w-full px-2 py-3 bg-white rounded-md z-10">
                        <div class="flex flex-col spacy-y-2">
                            <div class="w-full mb-4">
                                ...
                                <div class="flex">
                                    <input v-model="form.commission_amount" class="w-3/5 px-3 py-2 text-sm leading-tight text-gray-700 border rounded rounded-r-none mr-1 shadow appearance-none focus:outline-none focus:shadow-outline" id="commission" type="text" placeholder="Selling Commission">
                                    <div class="w-2/5 flex border bg-white rounded rounded-l-none">
                                        <div class="w-1/2 radio-uc inline-flex rounded-lg">
                                            <input
                                ...
                                <jet-input-error :message="form.errors.commission_amount" class="mt-2" />
                            </div>
                            <div class="w-full">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="status">Status</label>
                                <Multiselect id="status" v-model="form.status" mode="single" :options="statuses" openDirection="top" placeholder="Select Status" />
...
export default {
    ...
    methods: {
        ...
        submit () {
            if (this.form.id) {
                this.$inertia.post(route(this.prefix + 'products.update', this.form.id), {
